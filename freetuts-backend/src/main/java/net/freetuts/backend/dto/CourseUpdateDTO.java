...
public class CourseUpdateDTO {
	...
	public CourseUpdateDTO(UUID id, String courseName, Integer studyMethod, String courseLink, String linkName,
			Integer discount, Integer price, Integer type) {
		super();
		this.id = id;
	...
	public String toString() {
		return "CourseUpdateDTO [id=" + id + ", courseName=" + courseName + ", studyMethod=" + studyMethod
